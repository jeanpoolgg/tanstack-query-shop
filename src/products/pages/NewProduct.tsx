...
export const NewProduct = () => {
  ...
  const { control, handleSubmit, watch } = useForm<FormInputs>({
    defaultValues: {
      title: "Teclado",
      price: 150.22,
      description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima pariatur voluptatem quia a distin",
      category: "men's clothing",
      image: "https://metroio.vtexassets.com/arquivos/ids/459926/Teclado-Cl-sico-Slim-USB-Multilaser-1-351650060.jpg?v=638285828805600000",
